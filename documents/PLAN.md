...
* Заполнение поля "Номер карты" со статусами "APPROVED" и "DECLINED".
...
* Ввод букв кириллицы
* Ввод букв латиницы
* Ввод невалидного номера карты (например нули)
* Оставить поле пустым
* Ввод номера, состоящего из менее чем 16 цифр

**3.3 Заполнение поля "Месяц"**

* Ввод значения больше 12+
* Оставить поле пустым
* Ввод символа
* Ввод буквы
...
* Оставить поле пустым
* Ввод значения меньше текущего года
* Ввод значения, превышающего 10 лет от текущего года
* Ввод буквы
* Ввод символа
